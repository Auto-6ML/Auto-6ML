...
def get_dataset_or_loader(dataset_class: str, dataset_name: str or None, root: str,
                          ...
                          seed: int = 42, num_splits: int = 1, sampler="MyNeighborSampler",
                          **kwargs):
    """
    ...
    # Node or Link (One graph with given mask)
        ...
        if dataset_name == "ogbn-arxiv":
            ...
            transform_to_undirected = True if ("to_undirected" not in dataset_kwargs) else kwargs["to_undirected"]
        ...
        dataset = dataset[0]
        dataset.edge_index = to_undirected(dataset.edge_index, dataset.num_nodes)
